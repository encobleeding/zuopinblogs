...
$sortbk=$_GET['sort'];
 ...
 <?php
 $result = $mysql->selectData('blogs','*','1=1');
 ?>
      ...
      <div class="span12">
        ...
        <div class="widget orange">
          <div class="widget-title">
            <h4><i class="icon-reorder"></i>博客内容列表</h4>
            <span class="tools">
              ...
              <tbody>
               ...
               foreach ($result as $k => $v) {
                 ...
                 <tr>
                  ...
                  <td>
                   <a class="btn btn-primary change" name='change' value="<?=$v['aid']?>" href='./change.php?id=<?=$v['id']?>&sort=<?=$sortbk;?>'><i class="icon-pencil"></i></a>
                   <button class="btn btn-danger delete" name='delete' value="<?=$v['id']?>" index="<?=$sortbk?>"
