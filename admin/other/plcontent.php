...
?>
 ...
 <?php
  $result = $mysql->selectData('comment','*','1=1');
 ?>
 <a class='btn btn-success' style='width: 100px;margin-bottom: 10px;height: 40px;line-height: 40px;'
 id='btn_add' value="<?=$result['id']?>" name="btn-add" href='add.php'>添加</a>
 <!-- END PAGE HEADER-->
      ...
      <div class="span12">
        ...
        <div class="widget orange">
          <div class="widget-title">
            <h4 id="h44"><i class="icon-reorder"></i>用户评论列表</h4>
            <span class="tools">
            ...
            <table class="table table-striped table-bordered table-advance table-hover">
              ...
              <tbody>
               ...
               <tr>
                ...
                <td><?=$v['addtime']?></td>
                <td> 
                  <a class="btn btn-primary change" name='change' value="<?=$v['id']?>" href='./change.php?id=<?=$v['id']?>&sort=<?=$sortpl?>'><i class="icon-pencil"></i></a>
                  <button class="btn btn-danger delete" name='delete' value="<?=$v['id']?>" index="<?=$sortpl?>"
