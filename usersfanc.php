...
//		exit;
	...
	<div class="user-body">
		...
		<div class="body-left">
			<div class="left-head">
				<a href="usersartic.php?id=<?=$user['id']?>" class="avatar">
					<img src="<?=$user['img']?>"/>
				</a>
				<div class="title">
				...
				<div class="info">
					<ul class="list-inline">
						<li><div class="info-like"><a href="userstarget.php?id=<?=$user['id']?>"><span><?=$targets?></span><br />关注 ></a></div></li>
						<li><div class="info-like"><a href="usersfanc.php?id=<?=$user['id']?>"><span><?=$fancs?></span><br />粉丝 ></a></div></li>
						<li><div class="info-like"><a href="usersartic.php?id=<?=$user['id']?>"><span><?=$artics?></span><br />文章 ></a></div></li>
			...
			<ul class="left-menu list-inline">
				...
				<li class="active"><a href="usersfanc.php?id=<?=$user['id']?>">&nbsp;&nbsp;粉丝 <?=$fancs?></a><div class="line"></div></li>
				...
				?>
					<li class="artic">
						...
						<div class="name">
							...
							<p>关注 <?=$targs?> | 粉丝 <?=$fans?> | 文章 <?=$v['blognum']?></p>
							<p>写了 <?=$words?> 个字，获得了 <??> 个喜欢</p>
						</div>
						<a class="hidden"><?=$v['id']?></a>
				<?php
						if(in_array($self['id'], $v['fansid'])){
